...
```
    ...
    ## Warning: Removed 36342 rows containing missing values or values outside the scale range
    ## (`geom_point()`).
...
![](hy2912_p8105_hw3_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](hy2912_p8105_hw3_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
...
```
    ...
    ## ℹ In argument: `min1:min1440`.
    ## Caused by warning in `min1:min1440`:
    ## ! numerical expression has 229 elements: only the first used

    ## Warning: There were 6 warnings in `summarise()`.
    ## The first warning was:
    ## ℹ In argument: `mean_activity = mean(duration)`.
    ## ℹ In group 1: `min1:min1440 = 1.106`, `education = 1`, `sex = female`.
...
![](hy2912_p8105_hw3_files/figure-gfm/unnamed-chunk-51-1.png)<!-- -->
